    ...
    <div className={`${styles.page} ${poppins.variable} ${mono.variable}`}>
      ...
      <div className={styles.hero}>
        ...
        <p className={styles.heroSub}>
          ...
          Push to GitHub and VersionGate auto-deploys with blue-green switching, one-click rollback,
          crash recovery, and a React dashboard.
        </p>
      ...
      <div className={styles.statsBar}>
        ...
        <div className={styles.stat}>
          ...
          <div className={styles.statLabel}>PM2 processes (api + worker)</div>
        </div>
        <div className={styles.stat}>
          <div className={styles.statNum}>9</div>
          <div className={styles.statLabel}>core API route groups</div>
        </div>
        <div className={styles.stat}>
          <div className={styles.statNum}>7<span>d</span></div>
          <div className={styles.statLabel}>default session expiry window</div>
        </div>
      </div>
